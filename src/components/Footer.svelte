...
>
    ...
    <div class="flex flex-col gap-4 items-center justify-center">
        <p><b class="pr-2">Email</b> dmaxwell484@gmail.com</p>
        <p>
            <b class="pr-2">GitHub</b>
            <a href="https://github.com/dsm1015" target="_blank" class="text-violet-400"
                >dsm1015<sup class=""
        ...
        <p>
            ...
            <a href="https://www.linkedin.com/in/douglas-maxwell-7015b4215/" target="_blank" class="text-violet-400"
